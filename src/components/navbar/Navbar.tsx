    ...
    return (
        <nav className='my-5'>
             <div className='flex flex-wrap items-center justify-between p-4'>
                ...
                <div className={`${collapse ? "" : "hidden"} w-full my-2 outline outline-1 outline-slate-600 rounded shadow-xl md:block md:w-auto md:outline-none md:shadow-none font-Nunito`}>
